...
public class Car_Test{
	...
	@Before
	public void setup() {
		default_price = Car_Template.DEFAULT_PRICE;
		default_Text = Car_Template.DEFAULT_TEXT;
	}

	@Test
	public void test_create_normal_car(){
		Car_Template c = new Car(default_Text, default_price);
	...
	public void test_create_car_with_AC() {
		Car_Template c = new Car_Aircondition_Decorator(new Car(default_Text, default_price));
	...
	public void test_create_car_with_Panorama() {
		Car_Template c = new Car_Panorama_Decorator(new Car(default_Text, default_price));
	...
	public void test_create_car_with_Seat_Heat() {
		Car_Template c = new Car_Seat_Heat_Decorator(new Car(default_Text, default_price));
